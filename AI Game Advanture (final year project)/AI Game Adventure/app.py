...
def start_function():
    # message_label.config(text="Game start wait some times to load it", fg="blue")
    # message_label = Label(root, text="", font=("Times New Roman", 14))
...
start_button = Button(root, text="Start", height=1, width=10, bg="Yellow", fg="red", relief=RAISED,
                      font=("Times New Roman", 14, 'bold'), command=start_function)
